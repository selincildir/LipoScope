...
def plot_scenarios():
    ...
    fig.text(0.105, 0.908, "Lime-green bars show case-definition readiness; red bars show diagnostic-noise score. Scores are generated by LipoScope functions with mocked form inputs.", fontsize=10.8, color=SUBTEXT, ha="left")

    ax.bar([i - 0.18 for i in x], readiness, width=0.34, color="#7ED957", edgecolor="white")
